...
export default function Home() {
  ...
  // Busca as denúncias no backend do Railway
  ...
  const tiposUnicos = new Set(
    denuncias.map((d) => d.tipo_agressao)
  ).size;
  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      <header className="relative overflow-hidden bg-purple-900 text-white">
        <div className="relative max-w-6xl mx-auto px-4 py-20 sm:py-28">
          ...
          <div className="mt-8 flex flex-wrap gap-4">
            <a
              href="#denunciar"
              className="bg-white text-purple-900 font-medium px-6 py-3 rounded-xl hover:bg-purple-50 transition-colors"
            >
            ...
            <a
              href="#ajuda"
              className="border border-purple-200 text-white px-6 py-3 rounded-xl hover:bg-purple-700/40 transition-colors"
            >
              Canais de ajuda
            </a>
          </div>
        ...
        <div className="max-w-6xl mx-auto">
          ...
          >
            ...
            <Stat
              ...
              value={loading ? '…' : geoloc}
            />

            <Stat
              label="Tipos mapeados"
              value={loading ? '…' : tiposUnicos}
            />
          </div>
      ...
      <footer className="bg-purple-900 text-purple-200 py-8 px-4 text-center text-sm">
        <p>
          Agosto Lilás · Denúncias 100% anônimas · Nenhum dado pessoal é coletado.
        </p>
      </footer>
    </div>
  );
